...
function PulseBadge() {
  return (
    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-teal-50 border border-teal-200">
      ...
      <span className="text-sm text-teal-700 font-medium">Powered by Claude AI</span>
    </div>
  );
}
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-4">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        <PulseBadge />
        <h1 className="mt-8 text-5xl sm:text-6xl lg:text-7xl font-bold tracking-tight text-stone-900 text-balance">
          Stop Guessing.{" "}
          <span className="text-teal-600">Start Building.</span>
        </h1>
...
function FeatureCard({
  ...
  return (
    <div className="relative group">
      <div className="p-8 rounded-xl bg-white border border-stone-200 shadow-sm hover:shadow-md hover:border-teal-300 transition-all duration-300">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold text-stone-900 mb-4">
            ...
            <span className="text-teal-600">Ship Fast</span>
          </h2>
    ...
    <section id="how-it-works" className="py-24 px-4 relative">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="relative">
          {/* Connecting line */}
          <div className="absolute left-8 top-8 bottom-8 w-px bg-gradient-to-b from-teal-500 via-teal-300 to-teal-100 hidden md:block" />

          <div className="space-y-12">
            {steps.map((step, index) => (
              <div key={step.number} className="relative flex gap-8">
                <div className="relative z-10 flex-shrink-0 w-16 h-16 rounded-full bg-white border-2 border-teal-500 shadow-sm flex items-center justify-center">
